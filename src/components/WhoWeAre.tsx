...
const WhoWeAre = () => {
  ...
  return (
    <section id="who-we-are" className="py-16 sm:py-20 md:py-24 px-0 sm:px-6 ">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        <div className="flex flex-col relative lg:flex-row items-center gap-8 lg:gap-10 mt-8 sm:mt-10">
          <div>
          ...
          <br/>
          <p className="text-lg text-muted-foreground leading-relaxed">
            We deliver the IAM One-Stop Workstation, a comprehensive and integrated suite of fintech solutions and desk services that replaces generic facility support. Our platform and dedicated team—including specialized Fargo Space Partners Traders—streamline all aspects of your operations, from account opening and regulatory compliant communication to centralized trade support, automated risk control settings, and efficient Fee management. We are committed to injecting expertise, reliability, and innovation into your entire operational lifecycle.
          </p>
          </div>
          {/* <img className="w-full lg:w-1/2" src="/whoweare.jpeg" alt="Image about fargo space" /> */}
          <img
            className="w-full lg:w-1/2 max-h-[350px] select-none pointer-events-none object-cover"
            src="/who_we_are_v2.png"
