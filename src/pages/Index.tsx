      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-border shadow-sm">
        ...
        <nav className="container mx-auto px-3 sm:px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-2 h-20">
              <a href="#who-we-are" className="px-5 py-2 text-sm font-medium text-gray-700 hover:text-accent transition-colors relative group">
                Who We Are
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
              </a>

              <a href="#what-we-offer" className="px-5 py-2 text-sm font-medium text-gray-700 hover:text-accent transition-colors relative group">
                What We Offer
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
              </a>

              <a href="#contact" className="px-5 py-2 text-sm font-medium text-gray-700 hover:text-accent transition-colors relative group">
                Contact
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
              </a>
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="w-[280px] sm:w-[350px]">
                  ...
                  <nav className="flex flex-col gap-3">
                    <a 
                      href="#who-we-are" 
                      className="px-4 py-3 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-accent rounded-lg transition-colors"
                    >
                      Who We Are
                    </a>
                    <a 
